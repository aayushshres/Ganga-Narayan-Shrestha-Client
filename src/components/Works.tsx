...
const sectionLabel: Translatable = {
  en: "Writing & Thought",
  np: "लेखन र विचार",
};
const sectionTitle: Translatable = { en: "Writings", np: "लेखनहरू" };

const articlesLabel: Translatable = {
  en: "Articles & Literature",
  np: "लेख तथा साहित्य",
};
const booksLabel: Translatable = {
  en: "Published Books",
  np: "प्रकाशित पुस्तकहरू",
};
const songsLabel: Translatable = { en: "Songs", np: "गीतहरू" };

const viewAllArticles: Translatable = {
  en: "View All →",
  np: "सबै सम्पादन गर्नुहोस् →",
};
const viewAllBooks: Translatable = {
  en: "View All Books →",
  np: "सबै पुस्तकहरू सम्पादन गर्नुहोस् →",
};
const viewAllSongs: Translatable = {
  en: "View All Songs →",
  np: "सबै गीतहरू →",
};
            ...
            {articles.length > 0 &&
              articles.map((entry) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`latest-card__badge ${categoryColorMap[entry.category]}`}
                    >
                      {badge}
                    </span>
